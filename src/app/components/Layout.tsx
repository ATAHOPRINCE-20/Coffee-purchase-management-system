...
const navItems = [
  ...
  { icon: Coffee, label: "Processing", href: "/processing", roles: ["Admin", "Manager", "Field Agent", "Super Admin"] },
  ...
  { icon: BarChart3, label: "Reports", href: "/reports", roles: ["Admin", "Manager", "Super Admin"] },
